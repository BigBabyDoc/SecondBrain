    ...
    <form action={action} className="flex flex-col gap-2">
      ...
      {AUTO_RENEWAL_ENABLED && (
        ...
        >
          ...
          />
          <span>
            {/* Формулировка дословно повторяет Согласие № 2 п. 8: документ
                ссылается на текст поля, и он обязан совпадать с тем, что видел
                человек. Раскрытие по п. 8.1.3 идёт следом, отдельной строкой. */}
            <span className="text-foreground">
              Я согласен на автоматическое продление подписки и списание денежных
              средств с привязанной карты
            </span>
            <span className="mt-1 block">
              {PLAN_PRICES[period]} ₽ {PLAN_RENEWAL_CADENCE[period]}, первое списание —
              в день окончания оплаченного периода. Предупредим письмом за{" "}
              {RENEWAL_NOTICE_DAYS} дня и назовём карту; отключить можно в кабинете
              в одно действие.
            </span>
          </span>
        </label>
