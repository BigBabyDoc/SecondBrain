...
const FAQ: { question: string; answer: React.ReactNode }[] = [
  ...
  {
    question: "Как отменить продление?",
    answer: (
      <>
        В личном кабинете есть кнопка «Отключить автопродление». Доступ сохранится до конца
        оплаченного периода, дальше списаний не будет. Возобновить продление можно там же.
      </>
    ),
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-10 text-sm text-muted">
        ...
        <a
          href="mailto:Valeriy_Kuznetsov_02@mail.ru"
